...
function range901() {
    range90.style.transform = 'rotate(150deg)';
}
function range902() {
    range90.style.transform = 'rotate(155deg)';
}
function range903() {
    range90.style.transform = 'rotate(160deg)';
}
function range904() {
    range90.style.transform = 'rotate(170deg)';
}
